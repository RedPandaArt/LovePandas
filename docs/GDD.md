...
5. Победа → финальный удар вдвоём (общая анимация) → экран «Вы победили Дракона Рутины вместе!» → награды.
...
- Победа сохраняется в **общую историю пары** («12 марта победили Дракона Рутины») + трофей в локации.
