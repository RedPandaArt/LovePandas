...
|---|---|---|---|
| **А. Автобой** | Оба жмут «Готов» → анимация боя, исход по силе пары против силы босса | Просто сделать, красиво, быстро | Мало участия в самом бою |
| **Б. Рейд как в Habitica** | Босс висит неделю, каждое выполненное задание бьёт его по здоровью | Бой = сама жизнь пары, мотивирует делать задания | Меньше «момента» битвы |
| **В. Совместная мини-игра** | Оба в реальном времени тапают/делают комбо | Очень весело вдвоём | Сложно: нужен реалтайм-мультиплеер |

Предложение: **Б + финал А** — неделю бьём босса заданиями (его здоровье видно на экране),
а когда здоровье на исходе — оба жмут «Готов» и смотрят красивый добивающий автобой.
Вариант В — сильно позже, если будет ресурс.
